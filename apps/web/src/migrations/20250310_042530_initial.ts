...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoactThirds', 'full');
  ...
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'mediumImpact', 'lowImpact', 'gridBeam');
  ...
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'mediumImpact', 'lowImpact', 'gridBeam');
